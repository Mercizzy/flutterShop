class DetailInfoModel {
  ...
  DetailInfoModel({this.code, this.message, this.data});

  DetailInfoModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    data = json['data'] != null ? new DetailInfoData.fromJson(json['data']) : null;
  }
...
class DetailInfoData {
  ...
  DetailInfoData({this.goodInfo, this.goodComments, this.advertesPicture});

  DetailInfoData.fromJson(Map<String, dynamic> json) {
